...
use Mongator\Group\AbstractGroup as BaseAbstractGroup;
...
class AbstractGroupTest extends TestCase
{
    ...
    public function replace()
    {
        ...
        $replace = array(
            $this->mongator->create('Model\Comment')->fromArray(array('name' => 'ups')),
            $this->mongator->create('Model\Comment')->fromArray(array('text' => 'foobar')),
        );
        ...
        $this->assertEquals(array(
            $this->mongator->create('Model\Comment')->fromArray($savedData[0]),
            $this->mongator->create('Model\Comment')->fromArray($savedData[1])
        ), $group->getRemove());
    }
