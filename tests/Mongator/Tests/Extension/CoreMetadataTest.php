...
class CoreMetadataTest extends TestCase
{
    ...
    {
        $this->assertSame($this->metadataFactory->getClass('Model\Article'), $this->mongator->getRepository('Model\Article')->getMetadata());
        $this->assertSame($this->metadataFactory->getClass('Model\Source'), $this->mongator->getMetadataFactory()->getClass('Model\Source'));
    }
