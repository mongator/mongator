...
class CoreQueryForSaveTest extends TestCase
{
    ...
    {
        $article = $this->mongator->create('Model\Article')
            ->setAuthor($this->mongator->create('Model\Author')->setId($id = new \MongoId('123'))->setIsNew(false))
        ;
    ...
    public function testDocumentReferencesOneUpdate()
    {
        ...
        $article->setAuthor($this->mongator->create('Model\Author')->setId($id = new \MongoId('345'))->setIsNew(false));
    ...
    public function testDocumentReferencesManyInsert()
    {
        ...
        $ids = array();
        for ($i = 1; $i <= 10; $i ++) {
            $categories[] = $this->mongator->create('Model\Category')->setId($ids[] = new \MongoId($i));
        }
