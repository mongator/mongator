...
class CoreOnDeleteTest extends TestCase
{
    ...
    {
        $information1 = $this->mongator->create('Model\ArticleInformation')->setName('foo')->save();
        $information2 = $this->mongator->create('Model\ArticleInformation')->setName('foo')->save();
    ...
    {
        $element1 = $this->mongator->create('Model\FormElement')->setLabel('foo')->save();
        $element2 = $this->mongator->create('Model\TextareaFormElement')->setLabel('foo')->save();
        $element3 = $this->mongator->create('Model\RadioFormElement')->setLabel('foo')->save();
