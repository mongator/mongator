...
class LoggableMongoCollection extends \MongoCollection
{
     ...
     *
     * @return \Mongator\Logger\LoggableMongoDB The LoggableMongoDB
     */
...
*/
     ...
     * findOne.
     */
    public function findOne($query = array(), $fields = array(), array $options = null)
    {
        $cursor = new LoggableMongoCursor($this, $query, $fields, 'findOne' , $options);
        $cursor->limit(-1);
